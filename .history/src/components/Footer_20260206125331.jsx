...
const Footer = () => {
  return (
    <div className='flex justify-center text-light italic'>
      <div className='h-170 w-350 bg-[#E1664B] rounded-3xl '>
        ...
        <div className='flex justify-center mt-15'>
            <h1 className="text-[320px] leading-none tracking-tight text-white">
            PARFUM
            </h1>
        </div>
        <div className='text-white flex flex-row ml-15 mt-7'>
            <h1>Powered By WebFlow</h1>
            <h1 className='ml-230'>WebSite done By KIRAN</h1>
        </div>
      </div>
    </div>
  )
