...
const Gridbox = ({ image, name, description, price }) => {
  return (
    <div className="w-[500px] h-[00px] group flex flex-col items-center text-center gap-4  rounded-2xl bg-white hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
