...
const Gridbox = ({ image, name, description, price }) => {
  return (
    <div className="group flex flex-col items-center text-center gap-4  rounded-2xl bg-white hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">

      <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-pink-50 to-purple-50 p-6">
        <img
          src={image}
          alt={name}
          className="w-50 h-54 object-cover transition-transform duration-500 group-hover:scale-110"
        />
