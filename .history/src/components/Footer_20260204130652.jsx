  ...
  return (
    <div className='flex justify-center'>
      <div className='h-100 w-350 bg-pink-400 rounded-3xl flex flex-row '>
        ...
        <div className='mt-10 ml-150 text-white text-xl font-bold'>
            ...
            <div className='flex flex-row gap-10 mt-5 ml-2 '>
                <div className = 'flex flex-col'>
                    ...
                    <a classNamehref="" >Shop</a>
                    <a classNamehref="">About </a>
                    <a classNamehref="">Blog</a>
                    <a classNamehref="">Contact</a>
                    <a classNamehref="">T & C</a>
                </div>
                <div className = 'flex flex-col'>
                    <a classNamehref="">Shop</a>
                    <a classNamehref="">About </a>
