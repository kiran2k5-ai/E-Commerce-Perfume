...
const About = () => {
  ...
  return (
    <div>
      ...
      >
        <div className='absolute inset-0'><h1 className='flex text-5xl text-white font-light italic justify-center items-center py-100'>Infusing passion into every bottle.</h1></div>
