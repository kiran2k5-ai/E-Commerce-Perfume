    ...
    <div>
      ...
      <div className="flex justify-center gap-40 text-black mt-20">
        ...
        <img
          src={product.image}
          alt={product.name}
          className="mt-50 w-[300px] h-[300px] rounded-xl object-cover"
        />
          ...
          {related.length > 0 ? (
            related.map(item => (
              ...
              >
                ...
                <button className="mt-2 px-5 py-2 text-sm bg-gradient-to-r from-pink-300 to-purple-600 text-white rounded-full hover:shadow-md transition"
                onClick={addToCart}
      >
        Add to Cart
      </button>
