...
const About = () => {
  ...
  return (
    <div>
      ...
      <div className="flex flex-col justify-center items-center text-center mt-16 font-light italic gap-10">

  <h1 className="text-5xl">
    You’ve got questions, we’ve got answers.
  </h1>

  <div className="bg-pink-200 w-[600px] h-[250px] flex flex-col justify-center items-center text-center">
    <h1 className="text-xl font-semibold mb-2">
      How long can I expect the fragrance to last on my skin?
    </h1>
    <p className="text-sm">
      The longevity of our fragrances varies based on factors such as skin type,
      climate, and activity level. However, our carefully crafted scents are designed
      to have a lasting presence. On average, you can enjoy the captivating notes for
      6 to 8 hours.
    </p>
  </div>

  <div className="bg-pink-200 w-[600px] h-[200px] flex items-center justify-center">
