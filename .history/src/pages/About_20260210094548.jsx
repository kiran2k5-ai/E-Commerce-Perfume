  ...
  return (
    <div>
      ...
      >
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center bg-gradient-to-r from-pink-300 to-purple-300 bg-clip-text text-transparent px-6">
