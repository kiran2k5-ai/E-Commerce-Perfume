  ...
  return (
    <div>
      ...
      <div>
        ...
        <div>
            <h1>Auto Layout Horizontal</h1>
            <h2>The longevity of our fragrances varies based on factors such as skin type, brclimate, and activity level. However, our carefully crafted scents are designed to have a lasting presence. On average, you can enjoy the captivating notes for 6 to 8 hours. To enhance the longevity, consider applying the fragrance to pulse points and using our complementary scented body products.</h2>
        </div>
      </div>
