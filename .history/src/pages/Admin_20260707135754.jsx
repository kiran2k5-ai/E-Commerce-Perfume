      ...
      <div className="container mx-auto px-4 py-8 lg:py-12">
        <div className="grid gap-8 lg:grid-cols-[280px_1fr]">
          ...
          <div className="space-y-6">
            <div className="rounded-[2rem] bg-white/90 shadow-xl p-6 backdrop-blur-md">
              <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                <div>
                  <p className="text-sm uppercase tracking-[0.4em] text-pink-500">Admin summary</p>
              ...
              <p className="mt-4 text-sm text-gray-600 max-w-2xl">
                Manage products, orders, newsletter subscribers, and users with a polished admin UI that feels like the user dashboard.
              </p>
            </div>
            ...
            {loading ? (
              ...
              <>
                          ...
                          {products.map(product => (
                            <tr key={product._id} className="border-b border-gray-100 hover:bg-gray-50">
                              ...
                              <td className="p-4 flex flex-wrap gap-2">
                                <button className="rounded-2xl bg-purple-600 px-4 py-2 text-sm text-white">Edit</button>
                ...
                {activeTab === 'orders' && (
                  <div className="rounded-[2rem] bg-white p-6 shadow-xl space-y-4">
                ...
                {activeTab === 'subscribers' && (
                  <div className="rounded-[2rem] bg-white p-6 shadow-xl overflow-x-auto">
                      ...
                      <tbody>
                        {users.map(userItem => (
                          <tr key={userItem._id} className="border-b border-gray-100 hover:bg-gray-50">
                            ...
                            <td className="p-4 flex flex-wrap gap-2">
                              <button
                                onClick={() => updateUserRole(userItem._1, userItem.role === 'admin' ? 'user' : 'admin')}
