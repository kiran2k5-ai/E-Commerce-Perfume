  ...
  return (
    ...
    <div className='flex flex-row justify-center'> 
      ...
      <div>
        ...
        an irresistible aura that lingers like the sweetest reverie. Each note is meticulously crafted to transport you to a realm where your aspirations come alive, leaving an impression that's as lasting as the memory of a cherished dream.</h2>
      </div>
    </div>
    <Footer></Footer>
