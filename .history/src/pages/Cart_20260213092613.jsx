        ...
        <div className="container mx-auto px-4 sm:px-6 py-6 sm:py-10">
          <div className="flex flex-col lg:flex-row gap-6 sm:gap-10 items-start">
            <img
              ...
              className="w-full lg:w-[400px] h-[300px] sm:h-[400px] rounded-xl object-cover"
            />
            ...
            <div className="flex-1">
              ...
              <p className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-pink-400 to-purple-600 bg-clip-text text-transparent mb-4 sm:mb-6">
