  ...
  return (
    <div>
      ...
      <div className='flex flex-col justify-center item-center text-center mt-15 font-light italic gap-10'>
        ...
        <div className='bg-pink-200 w-[600px] h-[200px] flex flex-col justify-center item-center text-center'>
        ...
        <div className='bg-pink-200 w-[600px] h-[200px] text-center'><h1>Are your perfumes suitable for sensitive skin or allergies?</h1></div>
        <div className='bg-pink-200 w-[600px] h-[200px] text-center'><h1>How do you ensure your commitment to sustainability?</h1></div>
      </div>
