  ...
  return (
    <div>
      ...
      >
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-white bg-clip-text text-transparent px-6">
      ...
      >
        <div className="absolute inset-0 flex items-center justify-center absolute inset-0 bg-black/40">
          <h1 className="text-6xl font-bold italic text-white bg-clip-text text-transparent">
