    ...
    <div>
      ...
      <div className='flex flex-row gap-10 justify-center items-center mt-10'>
        <div className='flex flex-col gap-4'>
          ...
          <div className='w-25 h-10 rounded-3xl border px-5 py-2 border-orange-300'>News</div>
          <h1>Smell as gorgeous as you look.</h1>
          <h2>JULY 9, 2023 | 5 MIN READ</h2>
        </div>
        <div className='flex flex-col gap-4'>
          <img src={image13} alt="" className='w-100 h-70 rounded-2xl' />
          <div className='w-25 h-10 rounded-3xl border px-5 py-2 border-orange-300'>Products</div>
        ...
        <div className='flex flex-col gap-4'>
          ...
          <div className='w-25 h-10 rounded-3xl border px-5 py-2 border-orange-300'>Product</div>
      ...
      <div className='flex flex-row gap-10 justify-center items-center mt-10'>
        <div className='flex flex-col gap-4'>
          <img src={image12} alt="" className='w-100 h-70 rounded-2xl' />
          <div className='w-25 h-10 rounded-3xl border px-5 py-2 border-orange-300'>Company</div>
          <h1>How perfume affect your mood 
          and confidence.</h1>
          <h2>JULY 9, 2023 | 5 MIN READ</h2>
        </div>
        <div className='flex flex-col gap-4'>
        ...
        <div onClick={()=>{navigate('/')}} className='flex flex-col gap-4'>
          <img src={image14} alt="" className='w-100 h-70 rounded-2xl' />
          <div className='w-25 h-10 rounded-3xl border px-5 py-2 border-orange-300'>Product</div>
          <h1>Smell as gorgeous as you look.</h1>
          <h2 onClick={()=>{navigate('/')}}>JULY 25, 2023 | 5 MIN READ</h2>
        </div>
