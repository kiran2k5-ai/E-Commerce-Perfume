...
const Checkout = () => {
  ...
  return (
    <div className="min-h-screen flex justify-center items-center bg-gradient-to-r from-pink-50 via-white to-purple-50 p-4 sm:p-6 md:p-10">
      <div className="bg-white shadow-2xl rounded-2xl p-6 sm:p-8 md:p-10 w-full max-w-4xl">
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-serif italic mb-6 sm:mb-8 text-center bg-gradient-to-r from-pink-400 to-purple-600 bg-clip-text text-transparent">
          Checkout
        </h1>
