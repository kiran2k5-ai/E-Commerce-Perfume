    ...
    <div>
      ...
      <div className='flex flex-col justify-center items-center gap-10 font-light italic'>
        ...
        <div className='flex flex-row gap-20'>
            <input type="text" placeholder='Fullname' className='border border-amber-950 w-65 rounded px-6 w'/>
            <input type="text" placeholder='Email' className='border border-amber-950 w-65 rounded'/>
        </div>
