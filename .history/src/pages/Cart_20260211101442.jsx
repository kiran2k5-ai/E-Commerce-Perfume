    ...
    <div>
      <div className="flex justify-center gap-40 text-black">
        ...
        <img
          src={product.image}
          alt={product.name}
          className="w-[350px] h-[300px] mt-60 rounded-xl object-cover"
        />

        <div className="flex flex-col mt-32 gap-5 justify-center items-center text-xl font-serif italic border w-[520px] h-[600px] rounded-2xl">
