...
const About = () => {
  return (
    <div>
        ...
        <div>
            <div><h1>The Artisanal Difference</h1></div>
            <div>
                <div>
                    <h1>95%</h1>
                ...
                <div>
                    ...
                    <h2>Each of our fragrances is a result of creative vision. This commitment to artistic expression leads to scents that are 100% unique, testaments to our creativity and excellence.</h2>
                </div>
            </div>
        </div>
    </div>
