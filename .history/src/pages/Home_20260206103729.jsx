...
const Home = (id,name,description,price,image) => {
  const products = [
    { id: 1, name: "Meadow", description: "Breezy And Joyful", price: "$39.95", image: "" },
    { id: 2, name: "Noir", description: "Mysterious & Elegant", price: "$49.95", image: "" },
    { id: 3, name: "Rose Garden", description: "Romantic & Fresh", price: "$44.95", image: "" },
    { id: 4, name: "Ocean Breeze", description: "Cool & Refreshing", price: "$42.95", image: "" },
    { id: 5, name: "Amber Nights", description: "Warm & Sensual", price: "$54.95", image: "" },
    { id: 6, name: "Citrus Bloom", description: "Bright & Energetic", price: "$38.95", image: "" },
  ];
  return (
    <>
