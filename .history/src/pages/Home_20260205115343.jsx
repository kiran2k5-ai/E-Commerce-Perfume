...
const Home = (id,name,description,price,image) => {
  const products = [
    { id: {id}, name: "Meadow", description: "Breezy And Joyful", price: "$39.95", image: "src/images/image6.jpg" },
  ...
  return (
    ...
    <div className='flex flex-row justify-center gap-70 text-lg font-light italic mt-10'> 
