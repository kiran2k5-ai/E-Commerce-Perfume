...
const About = () => {
  ...
  return (
    <div>
      ...
      >
        <div className='absolute inset-0'><h1 className='flex text-6xl bg-gradient-to from-pink-400 to- font-light italic justify-center items-center py-60 font-bold'>Infusing passion into every bottle.</h1></div>
