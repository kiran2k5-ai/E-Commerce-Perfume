...
const Home = () => {
  ...
  return (
    ...
    <div className='relative h-screen overflow-hidden'>
      <div className="absolute inset-0 bg-gradient-to-br from-pink-200/30 via-purple-200/30 to-blue-200/30 z-10"></div>
      ...
      >
        <SwiperSlide>
          <img src="src\images\image3.jpg" alt="Hero 1" className='w-full h-full object-cover mix-blend-overlay'/>
        </SwiperSlide>
        <SwiperSlide>
          <img src="src\images\image2.jpg" alt="Hero 2" className='w-full h-full object-cover mix-blend-overlay'/>
        </SwiperSlide>
        <SwiperSlide>
          <img src="src\images\image3.jpg" alt="Hero 3" className='w-full h-full object-cover mix-blend-overlay'/>
        </SwiperSlide>
      </Swiper>
