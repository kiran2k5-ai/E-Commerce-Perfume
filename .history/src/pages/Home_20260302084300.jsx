    ...
    <>
      <div className='relative h-screen overflow-hidden font-light italic'>
        ...
        <div className='absolute inset-0 flex flex-col items-center justify-center text-white px-4 sm:px-6'>
          <h1 className='text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-center leading-tight mb-4 sm:mb-6'>
            Elevate EveryDay<br />
            Moments To<br />
          ...
          <button onClick = {()=>{navigate("/shop")}} className='mt-6 sm:mt-10 px-6 sm:px-10 py-3 sm:py-4 bg-white text-gray-800 rounded-full font-semibold text-base sm:text-lg hover:bg-pink-100 hover:scale-105 transition-all duration-300 shadow-2xl'>
            Explore Collection
          </button>
        </div>
      </div>

      <div className="bg-gradient-to-r from-pink-50 via-white to-purple-50 py-10 sm:py-16 md:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">

          <h2 className="text-center text-gray-400 uppercase tracking-widest text-xs sm:text-sm mb-6 sm:mb-10 font-semibold">
            Featured Brands
          </h2>
