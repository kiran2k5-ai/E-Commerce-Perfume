      ...
      <div className='flex flex-row justify-center item-center gap-100 text-black'>
        ...
        <div className='flex flex-col mt-50 gap-5 justify-center items-center text-2xl font-light italic'>
          ...
          breeze through wildflower fields,<br />
           ...
           refreshing notes.</h2>
          <div >
            <div className='flex flex-row gap-5'>Qty <div className='w-30 h-5 border-amber-900'>{count}</div>
          ...
          <div className='flex flex-row gap-45 w-85 h-10 bg-pink-100 pl-4'>SCENT NOTES <button>+</button></div>
          <div className='flex flex-row gap-45 w-85 h-10 bg-pink-100 pl-4'>INGREDIENTS <button>+</button></div>
        </div>
      </div>
    </div>
  )
