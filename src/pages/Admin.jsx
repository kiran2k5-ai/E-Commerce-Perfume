  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-white to-purple-50">
      <div className="container mx-auto px-4 sm:px-6 py-8 sm:py-12 md:py-16">
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center mb-8 sm:mb-12 bg-gradient-to-r from-pink-400 to-purple-600 bg-clip-text text-transparent">
          Admin Dashboard
        </h1>
          ...
          <div className="flex gap-2 sm:gap-4 mb-6 border-b overflow-x-auto">
            {['products', 'orders', 'subscribers'].map(tab => (
              <button
                ...
                className={`px-4 sm:px-6 py-2 sm:py-3 font-semibold capitalize whitespace-nowrap ${
                  activeTab === tab
